...
/*zimek*/ Object.values(playerDetails).forEach(player=>{if(player.uid=="165218")player.customImages=[{"x":"-2","y":"-2","url": "https://i.imgur.com/ZOiqaPE.png" },{"x":"0","y":"-2","url": "https://i.imgur.com/S7f2Fui.png" },{"x":"-2","y":"0","url": "https://i.imgur.com/nTMj0UP.png" },{"x":"0","y":"0","url": "https://i.imgur.com/r7qLTzA.png" }]});
 ...
 // Object.values(playerDetails).forEach(player=>{if(player.uid=="165218")player.numSides=7});
  Object.values(playerDetails).forEach(player=>{if(player.uid=="165218")player.skinUrl="https://i.imgur.com/cfNycmQ.png"});
...
/*sick*/	Object.values(playerDetails).forEach(player=>{if(player.uid=="322943")player.customImages=[{"x":"-2","y":"-2","url": "https://i.imgur.com/IwluV30.png" },{"x":"0","y":"-2","url": "https://i.imgur.com/CIv1ui0.png" },{"x":"-2","y":"0","url": "https://i.imgur.com/UQf50hu.png" },{"x":"0","y":"0","url": "https://i.imgur.com/EHGuB6n.png" }]});
  ...
  Object.values(playerDetails).forEach(player=>{if(player.uid=="322943")player.skinUrl="https://i.imgur.com/y369ZtZ.png"});
