...
/*zimek*/ Object.values(playerDetails).forEach(player=>{if(player.uid=="165218")player.customImages=[{"x":"-2","y":"-2","url": "https://i.imgur.com/CjZ2ojn.png" },{"x":"0","y":"-2","url": "https://i.imgur.com/frYH6gA.png" },{"x":"-2","y":"0","url": "https://i.imgur.com/Tvcr2xo.png" },{"x":"0","y":"0","url": "https://i.imgur.com/vZ7ZRNg.png" }]});
 ...
 // Object.values(playerDetails).forEach(player=>{if(player.uid=="165218")player.numSides=7});
  Object.values(playerDetails).forEach(player=>{if(player.uid=="165218")player.skinUrl="https://i.imgur.com/zvgKCfM.png"});
